...
export function Footer() {
  ...
  const footerLinks = {
    support: [
      ...
      { name: "Stone Dimensions", href: "/size-charts" },
    ],
    legal: [
        ...
        <div className="grid md:grid-cols-12 gap-8 mb-16">
          ...
          <div className="md:col-span-5 space-y-6">
            ...
            <p className="text-gray-500 leading-relaxed max-w-sm text-base font-light">
                Premium marble, granite, and mineral blocks crafted for luxury
                interiors and resilient construction. Sourced responsibly and
